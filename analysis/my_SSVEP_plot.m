...
SSVEP_tweny_gen = []; SSVEP_twenyFive_gen = []; SSVEP_twenyresp_gen = []; SSVEP_twenyFiveresp_gen = [];
...
SSVEP_tweny =  squeeze (ssvep.twenty_stim);
SSVEP_twenyFive = squeeze (ssvep.twentyFive_stim);

SSVEP_twenyresp =  squeeze (ssvep.twenty_resp);
SSVEP_twenyFiveresp = squeeze (ssvep.twentyFive_resp);

SSVEP_tweny_gen = nancat (2, SSVEP_tweny_gen, SSVEP_tweny); %[pp, steps, trial]
SSVEP_twenyFive_gen = nancat (2, SSVEP_twenyFive_gen, SSVEP_twenyFive); %[pp, steps, trial]


SSVEP_twenyresp_gen = nancat (2, SSVEP_twenyresp_gen, SSVEP_twenyresp); %[pp, steps, trial]
SSVEP_twenyFiveresp_gen = nancat (2, SSVEP_twenyFiveresp_gen, SSVEP_twenyFiveresp); %[pp, steps, trial]
...
SSVEPTwenyREspByPP = groupMeans(SSVEP_twenyresp_gen, 2, pp1, 'dim');% [trial, pp, step]
SSVEPTwenyREspByPP = permute (SSVEPTwenyREspByPP, [3 1 2]);


SSVEPTwenyFiveRByPP = groupMeans(SSVEP_twenyFiveresp_gen, 2, pp1, 'dim');% [trial, pp, step]
SSVEPTwenyFiveRByPP = permute (SSVEPTwenyFiveRByPP, [3 1 2]);
